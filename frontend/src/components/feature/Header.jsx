...
export default function Header() {
  ...
  return (
    <header className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-sm sticky top-0 z-50 transition-colors duration-300">
      <div className="w-full px-6 text-[15px]">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div
              className="font-bold text-2xl text-gray-800 dark:text-white tracking-tight"
          ...
          <nav className="hidden lg:flex items-center space-x-10">
            {navItems.map((item) => (
              <NavLink
                ...
                to={item.href}
                className={({ isActive }) => 
                  `font-semibold tracking-wide transition-all duration-300 transform hover:scale-105 cursor-pointer whitespace-nowrap ${
                    isActive
                      ? "text-blue-600 after:content-[''] after:block after:h-0.5 after:bg-blue-600 after:scale-x-100 after:transition-transform"
                      : "text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 after:content-[''] after:block after:h-0.5 after:bg-blue-600 after:scale-x-0 hover:after:scale-x-100 after:transition-transform"
                  }`
                }
              >
                {item.name}
          ...
          <div className="flex items-center space-x-5">
            ...
            <button
              ...
              className="lg:hidden p-2 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer"
            >
              <i
                className={
